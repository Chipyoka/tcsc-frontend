    ...
    return (
        <section className="py-12 flex justify-center items-center gap-x-12 mt-12">
             <div className="h-[550px] max-w-[500px] flex flex-col justify-between items-center gap-y-6">
                <div className="p-6">
                    <h3 className="text-5xl font-bold text-[var(--color-black)] text-[var(--color-primary)] mb-4">Smart Solutions.</h3>
            ...
            <div className="h-[550px] max-w-[820px] overflow-hidden rounded-xl">
